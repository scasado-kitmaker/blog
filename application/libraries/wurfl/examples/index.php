...
body,th,td,p {
	font-size: 12pt;
	font-family: Ubuntu, Calibri, Helvetica, Verdana, sans-serif;
}
...
<body>
	<div style="margin-left: auto; margin-right: auto; width: 700px; text-align: center">
		<div id="logo">&nbsp;</div>
		<br /><img src="http://www.scientiamobile.com/images/logos/wurfl_logo_word.gif" align="left" height="80" />
		...
		<p>Based on your current settings, your recommended cache type is: 
			<strong style="color: #009;"><?php echo $recommended['class_name']; ?></strong>
		</p>
		...
		<div class="<?php echo $cloud_class; ?>">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				<input type="text" size="50" maxlength="39" name="api_key" value="<?php echo $api_key; ?>" />
